...
export default function Home() {
  return <main>
    ...
    <section className="trust-row">
      <article><div className="trust-photo"><Image src={`${assetBase}/klampiarska-dielna.jpeg`} alt="Vozidlo po lakovaní priamo v lakovni Plechodesign" fill sizes="(max-width:800px) 82vw, 33vw" /></div><div className="trust-copy"><h2>Priamo v lakovni</h2><p>Poškodenie si pozrieme a navrhneme ďalší postup.</p></div></article>
      <article><div className="trust-photo"><Image src={`${assetBase}/priamo-v-lakovni.jpeg`} alt="Vozidlo počas klampiarskych prác v spolupracujúcej dielni" fill sizes="(max-width:800px) 82vw, 33vw" /></div><div className="trust-copy"><h2>Nadväzujúce práce</h2><p>Klampiareň a mechanická dielňa sú v rovnakej budove.</p></div></article>
