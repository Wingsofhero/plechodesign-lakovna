...
export default function InsurancePage(){return <main><Header />
  <section className="sub-hero insurance"><Image src="/images/gallery/praca-23.webp" alt="Poškodené vozidlo pripravené na opravu" fill priority sizes="100vw"/><div className="sub-overlay"/><div><p className="overline">POISTNÉ UDALOSTI</p><h1>Pomôžeme vám<br />postupovať <em>pokojne.</em></h1><p>Spolupracujeme s odborníkom na poistné udalosti. Prvým kontaktom zostáva Plechodesign a potrebné kroky s vami prejdeme.</p></div></section>
